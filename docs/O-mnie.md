...
Poza pracą i GISBoost sędziuję koszykówkę, od 2018 roku.

## Umiejętności

- GIS i kartografia: QGIS, ArcGIS, AutoCAD Map 3D
- Modelowanie 3D: Blender, SketchUp
- Projektowanie CAD: AutoCAD
- Grafika: Inkscape, GIMP
- Programowanie narzędzi GIS: Python (wtyczki processing QGIS, pipeline'y danych GTFS/GTFS-RT)
